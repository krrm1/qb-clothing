...
Tattoos = {
	[1] = {shopType = 'tattoo', coords = vector3(1322.645, -1651.976, 52.275), width = 2, length = 2},
    [2] = {shopType = 'tattoo', coords = vector3(-1153.676, -1425.68, 4.954), width = 2, length = 2},
    [3] = {shopType = 'tattoo', coords = vector3(322.139, 180.467, 103.587), width = 2, length = 2},
    [4] = {shopType = 'tattoo', coords = vector3(-3170.071, 1075.059, 20.829), width = 2, length = 2},
    [5] = {shopType = 'tattoo', coords = vector3(1864.633, 3747.738, 33.032), width = 2, length = 2},
    [6] = {shopType = 'tattoo', coords = vector3(-293.713, 6200.04, 31.487), width = 2, length = 2},
    [7] = {shopType = 'tattoo', coords = vector3(-1220.6872558594, -1430.6593017578, 4.3321843147278), width = 2, length = 2},
	[8] = {shopType = 'tattoo', coords = vector3(-1115.3640136719, -1658.7386474609, 4.3555798530579), width = 2, length = 2}
}

Citizen.CreateThread(function()
    for k, v in pairs (Tattoos) do
        if Tattoos[k].shopType == "tattoo" then
            local tattooShop = AddBlipForCoord(Tattoos[k].coords)
