...
QBCore.Commands.Add("skin", "Open the skin menu", {}, false, function(source, args)
...
AddEventHandler("clothing:checkMoney", function(menu,askingPrice)
    ...
    if (target['PlayerData']['money']['cash'] >= askingPrice) then
        ...
        TriggerClientEvent('QBCore:Notify', src, 'Removed Form You $' .. askingPrice .. '', 'success', 5000)
        TriggerClientEvent("raid_clothes:hasEnough",src,menu)
    else
        -- TriggerClientEvent("DoShortHudText",src, "Je moet €"..askingPrice.." + BTW.",2)
        TriggerClientEvent('QBCore:Notify', src, 'You Need $' .. askingPrice .. ' Cash', 'error', 5000)
