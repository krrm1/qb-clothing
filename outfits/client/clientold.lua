...
local Locations = {
    ...
    {475.51443, -989.5452, 33.217071, 269.51901},
}

RegisterNetEvent("qb-outfits:client:tryUI")
AddEventHandler("qb-outfits:client:tryUI", function(outfits, tsd)
    local plyPed = PlayerPedId()
    local plyCoords = GetEntityCoords(plyPed)
    if tsd then
        TriggerEvent("qb-outfits:client:openUI", outfits)
        return
    end
...
RegisterNetEvent("qb-outfits:client:openUI")
AddEventHandler("qb-outfits:client:openUI", function(outfits)
    local html = ""
...
RegisterNetEvent("qb-outfits:client:updateUI")
AddEventHandler("qb-outfits:client:updateUI", function(outfits)
    local html = ""
...
RegisterNetEvent("qb-outfits:client:SetClothing")
AddEventHandler("qb-outfits:client:SetClothing", function(data)
...
RegisterNUICallback('CreateOutfit', function(data)
    ...
    TriggerServerEvent("qb-outfits:server:create", data.slot, data.name, temp_data)
end)

RegisterNUICallback('DeleteOutfit', function(data)
    TriggerServerEvent("qb-outfits:server:delete", data.slot)
end)

RegisterNUICallback('SelectOutfit', function(data)
    TriggerServerEvent("qb-outfits:server:use", data.slot)
end)
